'''
CE block: Concatenate excitation block
add global_average_pooling to the excitation of SE block.

Sigmoid(
    Conv1X1(
        Concatenate[GAP,FC(GAP)]
    )
)
